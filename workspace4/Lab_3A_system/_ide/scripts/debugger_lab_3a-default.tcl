...
# Path of this script: X:\workspace3\Lab_3A_system\_ide\scripts\debugger_lab_3a-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source X:\workspace3\Lab_3A_system\_ide\scripts\debugger_lab_3a-default.tcl
# 
